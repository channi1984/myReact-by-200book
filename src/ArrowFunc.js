...
class ArrowFunc extends Component {
    ...
    Function3() {
        var this_bind = this;
        setTimeout(function () {
            console.log(this_bind.state.num + '. Es5 Callbak Function nobind :');
            console.log(this_bind.state.arrowFuc);
        }, 100);
    }
    Function4() {
        setTimeout(function () {
            console.log('4. Es5 callbak Function Bind :' + this.state.arrwFunc);
        }.bind(this), 100);
    }
    Function5 = (num1, num2, num3) => {
        const num4 = num1 + num2 + num3;
        setTimeout(() => {
            console.log(num4 + '.Arrow Callbak Function :' + this.state.arrowFuc);
        }, 100);
    }
